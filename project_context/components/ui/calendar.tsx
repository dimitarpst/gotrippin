    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-white/50 hover:text-white border-white/10 hover:bg-white/10",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell: "text-white/40 rounded-md w-9 font-semibold text-xs uppercase",
        ...
        day_selected: "bg-[#ff6b6b] text-white hover:bg-[#ff6b6b] hover:text-white focus:bg-[#ff6b6b] focus:text-white",
        day_today: "bg-white/10 text-white font-bold",
        day_outside: "day-outside text-white/20 aria-selected:bg-white/5 aria-selected:text-white/40",
