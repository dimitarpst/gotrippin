    ...
    <>
      <div className="min-h-screen relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 px-6 pt-12 flex items-center justify-between">
          <button onClick={onBack} className="text-[#ff6b6b] text-lg font-medium">
            Cancel
          </button>
          <button onClick={handleSave} className="px-6 py-2 rounded-full bg-white text-black font-semibold">
            Save
          </button>
        </div>
